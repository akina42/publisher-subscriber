...
public class SubscriberImpl3 extends java.rmi.server.UnicastRemoteObject implements ISubscriber3 {

    public SubscriberImpl3()
    ...
    public void inputSubscriber()
        ...
        try{
            ...
            intermediary3.receiveSubscribe(listSubscriptions, nameNode);
        }
        catch (Exception e){
            System.out.println("\nErro: " + e);
        }
